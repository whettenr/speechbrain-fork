...
if __name__ == "__main__":
    ...
    # reinitilize last n layers
    reinit_layers = list(range(0,hparams["num_encoder_layers"]))[-hparams["reinit_last"]:]
    print("reinitilizing layers: ", reinit_layers)
    asr_brain.modules.enc.transformer.encoder.reinitialize_layers(reinit_layers)
